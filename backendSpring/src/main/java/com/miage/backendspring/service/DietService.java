...
public class DietService {
    ...
    /**
     * Generate a map of the weekly diet containing 2 dishes a day randomly by user nutritional profile
    ...
    /**
     * If the weekly diet not regenerated by user, this method is called to save the weeklyDietString (in database) of the weekly diet mapped object
     *
     * @param username
     * @param regenerate
     * @return
